...
export const ProgrammeSummary = ({ form }) => {
    ...
    const handleEdit = () => history.push(`/app/dashboard/build_form/${form?.id}`)

    return (
        <div className="programme-summary">
            <Row>
                <Col span={24}>
                    <Card title="Programme Summary" extra={<Button onClick={handleEdit} icon={<EditOutlined />} type="primary" ghost shape="round">Edit</Button>} >
                        <Row gutter={[16,16]}>
                            <Col span={12}>
